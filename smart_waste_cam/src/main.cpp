...
// DO NOT include esp_http_server.h - it conflicts with ESPAsyncWebServer
// #include "esp_http_server.h"  // ← REMOVE THIS LINE
#include <WebSocketsServer.h>
#include <HTTPClient.h>  // ← ADD THIS for HTTP POST requests
...
void setupCamera() {
  ...
  config.pin_sccb_sda = SIOD_GPIO_NUM;  // ← Fixed: use pin_sccb_sda (not pin_sscb_sda)
  config.pin_sccb_scl = SIOC_GPIO_NUM;  // ← Fixed: use pin_sccb_scl (not pin_sscb_scl)
